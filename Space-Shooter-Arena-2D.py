...
pygame.display.set_caption("Spaceship Warfare 2D")
...
WINNER_FONT = pygame.font.SysFont('sansserif', 100)
...
def handle_red_movement(keys_pressed, red):
		...
		if keys_pressed[pygame.K_UP] and red.y - VELOCITY > 0:
			red.y -= VELOCITY
		if keys_pressed[pygame.K_DOWN] and red.y + VELOCITY + red.height + 15 < HEIGHT:
			red.y += VELOCITY
...
def draw_winner(text):
	...
	WIN.blit(draw_text, (WIDTH/2 - draw_text.get_width()/2, HEIGHT / 2 - draw_text.get_width()/2 + 180))
	pygame.display.update()
